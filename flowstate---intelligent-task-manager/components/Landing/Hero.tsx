        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-400 max-w-lg leading-relaxed">
              Stop drowning in tasks. FlowState uses intelligent sorting and AI breakdowns to help you focus on what actually matters, right now.
            </p>
            ...
            <div className="flex items-center gap-4 text-sm text-gray-500 pt-4">
              <div className="flex -space-x-2">
                 {[1,2,3,4].map(i => (
                   <img key={i} src={`https://picsum.photos/32/32?random=${i}`} className="w-8 h-8 rounded-full border-2 border-gray-950" alt="User" />
                 ))}
              </div>
