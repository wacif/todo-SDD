      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <PricingCard 
            ...
            description="For teams that need collaborative project planning."
            features={["Everything in Pro", "Unlimited team members", "Admin dashboard", "Priority support", "Custom integrations"]}
            delay={0.2}
          />
        </div>
      </div>
